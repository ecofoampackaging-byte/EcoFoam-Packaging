  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-white/95 backdrop-blur-md shadow-md border-b border-neutral-200/80 py-0"
          : "bg-[#FBFBF9]/95 backdrop-blur-sm border-b border-black/5"
      }`}
    >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-[#FBFBF9] border-b border-neutral-200 px-6 pt-4 pb-6 space-y-4 overflow-hidden"
          >
            ...
            <div className="pt-4 border-t border-neutral-200 flex flex-col space-y-3">
              <button
                ...
                className="w-full py-2.5 text-xs font-medium text-center border border-neutral-800 text-neutral-900 rounded-sm hover:bg-neutral-100 transition-colors"
              >
                Order Sample
              </button>
