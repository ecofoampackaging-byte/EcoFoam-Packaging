...
import { ShieldCheck, Recycle, PenTool, ArrowRight, Sparkles } from "lucide-react";
            ...
            <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 w-full py-16 lg:py-24">
              ...
              >
                ...
                >
                  ...
                  <span>EXCELLENCE IN MEDICINE & PHARMA BOTTLES</span>
                </motion.div>
                ...
                >
                  <Link
                    href="/products"
                    className="inline-flex items-center justify-center px-7 py-3.5 bg-[#121212] text-white text-xs tracking-wider uppercase font-medium rounded-sm hover:bg-[#2b2b2b] transition-all duration-300 shadow-md group cursor-pointer"
                  >
